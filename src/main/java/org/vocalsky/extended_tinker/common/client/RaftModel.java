...
@OnlyIn(Dist.CLIENT)
public class RaftModel extends ListModel<TconBorderEntity> {
    ...
    public void setupAnim(TconBorderEntity p_249733_, float p_249202_, float p_252219_, float p_249366_, float p_249759_, float p_250286_) {
    ...
    private static void animatePaddle(TconBorderEntity p_250792_, int p_249947_, ModelPart p_248943_, float p_251990_) {
