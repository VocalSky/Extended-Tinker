package org.vocalsky.extended_tinker.common.client.screen;
...
public class UltraPartBuilderScreen extends BaseTabbedScreen<UltraPartBuilderBlockEntity, UltraPartBuilderContainerMenu> {
...
//    private static final ResourceLocation BACKGROUND = Extended_tinker.getResource("textures/gui/ultra_part_builder.png");
//    // locations
//    // slider
...
//    public UltraPartBuilderScreen(UltraPartBuilderContainerMenu container, Inventory playerInventory, Component title) {
...
//
//    @Override
//    public void warning(@NotNull Component message) {
...
private static final Component INFO_TEXT = TConstruct.makeTranslation("gui", "part_builder.info");
    ...
    private void drawRecipesBackground(GuiGraphics graphics, int mouseX, int mouseY, int left, int top) {
        ...
        for (int i = this.recipeIndexOffset; i < max; i++) {
            ...
            if (mouseX >= x && mouseY >= y && mouseX < x + PATTERN_SIZE && mouseY < y + PATTERN_SIZE) {
                v += 2 * PATTERN_SIZE;
            }
