...
@OnlyIn(Dist.CLIENT)
public class BoatModel extends ListModel<TconBorderEntity> implements WaterPatchModel {
    ...
    public void setupAnim(TconBorderEntity p_102269_, float p_102270_, float p_102271_, float p_102272_, float p_102273_, float p_102274_) {
    ...
    private static void animatePaddle(TconBorderEntity p_170465_, int p_170466_, ModelPart p_170467_, float p_170468_) {
