...
public class ModifierRecipeProvider extends BaseRecipeProvider {
    ...
    private void addModifierRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        crystalshotRecipe.accept(TinkerWorld.earthGeode.getBud(GeodeItemObject.BudSize.CLUSTER), "earthslime");
        crystalshotRecipe.accept(TinkerWorld.skyGeode.getBud(GeodeItemObject.BudSize.CLUSTER), "skyslime");
        crystalshotRecipe.accept(TinkerWorld.ichorGeode.getBud(GeodeItemObject.BudSize.CLUSTER), "ichor");
        crystalshotRecipe.accept(TinkerWorld.enderGeode.getBud(GeodeItemObject.BudSize.CLUSTER), "enderslime");
        ...
        SwappableModifierRecipeBuilder.modifier(TinkerModifiers.crystalshot, "random")
                .addInput(Ingredient.of(TinkerWorld.earthGeode.getBud(GeodeItemObject.BudSize.CLUSTER), TinkerWorld.skyGeode.getBud(GeodeItemObject.BudSize.CLUSTER)))
                .addInput(Ingredient.of(Items.AMETHYST_CLUSTER, Items.NETHER_QUARTZ_ORE))
                .addInput(Ingredient.of(TinkerWorld.ichorGeode.getBud(GeodeItemObject.BudSize.CLUSTER), TinkerWorld.enderGeode.getBud(GeodeItemObject.BudSize.CLUSTER)))
                .addInput(TinkerMaterials.manyullyn.getIngotTag())
                .addInput(TinkerMaterials.manyullyn.getIngotTag())
                .setTools(TinkerTags.Items.BOWS)
                .setSlots(SlotType.ABILITY, 1)
        ...
        ModifierSetWorktableRecipeBuilder.setRemoving(hiddenModifiers)
                .modifierPredicate(blacklist)
                .addInput(FluidContainerIngredient.fromIngredient(FluidIngredient.of(Tags.Fluids.MILK, FluidType.BUCKET_VOLUME), Ingredient.of(Items.MILK_BUCKET)))
