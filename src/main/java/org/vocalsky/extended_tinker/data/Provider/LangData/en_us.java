...
public class en_us implements ILang {
    enum LangData implements ILangData {
        ...
        SHOOT_FIREWORK("modifier.extended_tinker.shoot_firework", "Firework Shooter"),
        SHOOT_FIREWORK_FLAVOR("modifier.extended_tinker.shoot_firework.flavor", "Shoot fireworks!"),
        SHOOT_FIREWORK_DESCRIPTION("modifier.extended_tinker.shoot_firework.description", "Gives the bow one toggleable firecrack slots. Select the slot by attacking, or access them by sneaking and attacking"),
        SHOOT_FIREWORK_SELECTED("modifier.extended_tinker.shoot_firework.selected", "Firework Shooter: Selected %s from slot %s"),
        SHOOT_FIREWORK_DISABLED("modifier.extended_tinker.shoot_firework.disabled", "Firework Shooter: Disabled"),
        FIREWORK_STAR("modifier.extended_tinker.firework_star", "Firework Shooter"),
        FIREWORK_STAR_FLAVOR("modifier.extended_tinker.firework_star.flavor", "Shoot fireworks!"),
        FIREWORK_STAR_DESCRIPTION("modifier.extended_tinker.firework_star.description", "Gives the bow one firework slots. Select the slot by attacking, or access them by sneaking and attacking"),
        ...
        SAFETY_FIREWORK("modifier.extended_tinker.safety_firework", "Safety Firework"),
        SAFETY_FIREWORK_FLAVOR("modifier.extended_tinker.safety_firework.flavor", "Safety First!"),
        SAFETY_FIREWORK_DESCRIPTION("modifier.extended_tinker.safety_firework.description", "Firework will not hurts its owner."),
        ...
        GOLEM_BOOTS("item.extended_tinker.golem_boots", "Golem Armor Boots"),
        GOLEM_BOOTS_DESCRIPTION("item.extended_tinker.golem_boots.description", "Customized for the metal golem."),
        ...
        PATTERN_BOOTS_GOLEM_PLATING("pattern.extended_tinker.boots_golem_plating", "Stone Golem Boots Plating"),
        BOOTS_GOLEM_PLATING_DUMMY("item.extended_tinker.boots_golem_plating_dummy", "Golem Boots Plating"),
        BOOTS_GOLEM_PLATING("item.extended_tinker.boots_golem_plating", "Golem Boots Plating"),
        BOOTS_GOLEM_PLATING_SAND_CAST("item.extended_tinker.boots_golem_plating_sand_cast", "Golem Boots Plating Sand Cast"),
        BOOTS_GOLEM_PLATING_RED_SAND_CAST("item.extended_tinker.boots_golem_plating_red_sand_cast", "Golem Boots Plating Red Sand Cast"),
        BOOTS_GOLEM_PLATING_CAST("item.extended_tinker.boots_golem_plating_cast", "Golem Boots Plating Gold Cast"),
        GOLEM_BEACON("modifier.extended_tinker.golem_beacon", "Golem Beacon"),
        GOLEM_BEACON_FLAVOR("modifier.extended_tinker.golem_beacon.flavor", "Beacon under golems!"),
        GOLEM_BEACON_DESCRIPTION("modifier.extended_tinker.golem_beacon.description", "Same as the beacon boots."),
        GOLEM_WEAPON("modifier.extended_tinker.golem_weapon", "Golem Weapon"),
        GOLEM_WEAPON_FLAVOR("modifier.extended_tinker.golem_weapon.flavor", "Perform as Golem's weapon!"),
        GOLEM_WEAPON_DESCRIPTION("modifier.extended_tinker.golem_weapon.description", "Golems can use this weapon now."),
        ...
        DRAGON_ARMOR_HEAD_DESCRIPTION("item.extended_tinker.dragonarmor_head.description", "Dragon armor is a special kind of armor that cannot be created with traditional skill, but you can try to get the help from the ender dragon and the dragon forge."),
        DRAGON_ARMOR_BODY_DESCRIPTION("item.extended_tinker.dragonarmor_body.description", "Dragon armor is a special kind of armor that cannot be created with traditional skill, but you can try to get the help from the ender dragon and the dragon forge."),
        DRAGON_ARMOR_NECK_DESCRIPTION("item.extended_tinker.dragonarmor_neck.description", "Dragon armor is a special kind of armor that cannot be created with traditional skill, but you can try to get the help from the ender dragon and the dragon forge."),
        DRAGON_ARMOR_TAIL_DESCRIPTION("item.extended_tinker.dragonarmor_tail.description", "Dragon armor is a special kind of armor that cannot be created with traditional skill, but you can try to get the help from the ender dragon and the dragon forge."),
        ...
        STAT_DRAGON_ARMOR_CORE_HEAD("stat.extended_tinker.dragon_armor_head_core", "Dragon Armor Core"),
        STAT_DRAGON_ARMOR_CORE_BODY("stat.extended_tinker.dragon_armor_body_core", "Dragon Armor Core"),
        STAT_DRAGON_ARMOR_CORE_NECK("stat.extended_tinker.dragon_armor_neck_core", "Dragon Armor Core"),
        STAT_DRAGON_ARMOR_CORE_TAIL("stat.extended_tinker.dragon_armor_tail_core", "Dragon Armor Core"),
