...
public class en_us implements ILang {
    enum LangData implements ILangData {
        ...
        STAT_DRAGON_ARMOR_IRON("stat.extended_tinker.dragonarmor_iron", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_COPPER("stat.extended_tinker.dragonarmor_copper", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_SILVER("stat.extended_tinker.dragonarmor_silver", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_GOLD("stat.extended_tinker.dragonarmor_gold", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_DIAMOND("stat.extended_tinker.dragonarmor_diamond", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_FIRE("stat.extended_tinker.dragonarmor_fire", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_ICE("stat.extended_tinker.dragonarmor_ice", "Dragon Armor Base"),
        STAT_DRAGON_ARMOR_LIGHTNING("stat.extended_tinker.dragonarmor_lightning", "Dragon Armor Base"),
