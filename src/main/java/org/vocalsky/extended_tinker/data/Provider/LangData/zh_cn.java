...
public class zh_cn implements ILang {
    enum LangData implements ILangData {
        ...
        PART_DRAGON_ARMOR_COPPER_CORE_HEAD("item.extended_tinker.dragon_armor_copper_core_head", "头部基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_BODY("item.extended_tinker.dragon_armor_copper_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_NECK("item.extended_tinker.dragon_armor_copper_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_TAIL("item.extended_tinker.dragon_armor_copper_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_HEAD("item.extended_tinker.dragon_armor_silver_core_head", "头部基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_BODY("item.extended_tinker.dragon_armor_silver_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_NECK("item.extended_tinker.dragon_armor_silver_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_TAIL("item.extended_tinker.dragon_armor_silver_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_IRON_CORE_HEAD("item.extended_tinker.dragon_armor_iron_core_head", "头部基底"),
        PART_DRAGON_ARMOR_IRON_CORE_BODY("item.extended_tinker.dragon_armor_iron_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_IRON_CORE_NECK("item.extended_tinker.dragon_armor_iron_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_IRON_CORE_TAIL("item.extended_tinker.dragon_armor_iron_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_HEAD("item.extended_tinker.dragon_armor_gold_core_head", "头部基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_BODY("item.extended_tinker.dragon_armor_gold_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_NECK("item.extended_tinker.dragon_armor_gold_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_TAIL("item.extended_tinker.dragon_armor_gold_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_HEAD("item.extended_tinker.dragon_armor_diamond_core_head", "头部基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_BODY("item.extended_tinker.dragon_armor_diamond_core_body", "钻石躯体基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_NECK("item.extended_tinker.dragon_armor_diamond_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_TAIL("item.extended_tinker.dragon_armor_diamond_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_HEAD("item.extended_tinker.dragon_armor_dragonsteel_fire_core_head", "头部基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_BODY("item.extended_tinker.dragon_armor_dragonsteel_fire_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_NECK("item.extended_tinker.dragon_armor_dragonsteel_fire_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_TAIL("item.extended_tinker.dragon_armor_dragonsteel_fire_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_ICE_CORE_HEAD("item.extended_tinker.dragon_armor_dragonsteel_ice_core_head", "头部基底"),
        PART_DRAGON_ARMOR_ICE_CORE_BODY("item.extended_tinker.dragon_armor_dragonsteel_ice_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_ICE_CORE_NECK("item.extended_tinker.dragon_armor_dragonsteel_ice_core_neck", "脖颈基底"),
        PART_DRAGON_ARMOR_ICE_CORE_TAIL("item.extended_tinker.dragon_armor_dragonsteel_ice_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_LIGHTNING_CORE_HEAD("item.extended_tinker.dragon_armor_dragonsteel_lightning_core_head", "头部基底"),
        PART_DRAGON_ARMOR_LIGHTNING_CORE_BODY("item.extended_tinker.dragon_armor_dragonsteel_lightning_core_body", "躯体基底"),
        PART_DRAGON_ARMOR_LIGHTNING_CORE_NECK("item.extended_tinker.dragon_armor_dragonsteel_lightning_core_neck", "脖颈基底"),
