...
public class zh_cn implements ILang {
    enum LangData implements ILangData {
        ...
        FIRECRACK_DESCRIPTION("item.extended_tinker.firecrack.description", "烟火是一种模块化的工具。使用时需要手持打火石来点燃。"),
        FIREWORK_FLIGHT("modifier.extended_tinker.firework_flight", "飞行"),
        FIREWORK_FLIGHT_FLAVOR("modifier.extended_tinker.firework_flight.flavor", "它能飞多久？"),
        FIREWORK_FLIGHT_DESCRIPTION("modifier.extended_tinker.firework_flight.description", "影响飞行时间。"),
        SHOOT_FIREWORK("modifier.extended_tinker.shoot_firework", "烟火发射器"),
        SHOOT_FIREWORK_FLAVOR("modifier.extended_tinker.shoot_firework.flavor", "发射烟火！"),
        SHOOT_FIREWORK_DESCRIPTION("modifier.extended_tinker.shoot_firework.description", "给予弓1个烟火槽位；手持弓并按下“攻击”键以切换槽位，潜行时并按下“攻击”键以访问这些槽位"),
        SHOOT_FIREWORK_SELECTED("modifier.extended_tinker.shoot_firework.selected", "烟火发射器：选用%2$s号槽位中%1$s"),
        SHOOT_FIREWORK_DISABLED("modifier.extended_tinker.shoot_firework.disabled", "烟火发射器：禁用"),
        FIREWORK_STAR("modifier.extended_tinker.firework_star", "烟火之星"),
        FIREWORK_STAR_FLAVOR("modifier.extended_tinker.firework_star.flavor", "搭载烟火之星"),
        FIREWORK_STAR_DESCRIPTION("modifier.extended_tinker.firework_star.description", "拥有了烟火之星的能力。"),
        SAFETY_FIREWORK("modifier.extended_tinker.safety_firework", "安全烟花"),
        SAFETY_FIREWORK_FLAVOR("modifier.extended_tinker.safety_firework.flavor", "安全第一！"),
        SAFETY_FIREWORK_DESCRIPTION("modifier.extended_tinker.safety_firework.description", "烟花将不再伤害到使用者。"),
        ...
        GOLEM_BOOTS("item.extended_tinker.golem_boots", "傀儡装甲战靴"),
        GOLEM_BOOTS_DESCRIPTION("item.extended_tinker.golem_boots.description", "为大型金属傀儡定制。"),
        ...
        HELMET_GOLEM_PLATING_CAST("item.extended_tinker.helmet_golem_plating_cast", "傀儡头盔镶板金质铸模"),
        ...
        CHESTPLATE_GOLEM_PLATING_CAST("item.extended_tinker.chestplate_golem_plating_cast", "傀儡胸甲镶板金质铸模"),
        ...
        LEGGINGS_GOLEM_PLATING_CAST("item.extended_tinker.leggings_golem_plating_cast", "傀儡护腿镶板金质铸模"),
        PATTERN_BOOTS_GOLEM_PLATING("pattern.extended_tinker.boots_golem_plating", "傀儡战靴镶板"),
        BOOTS_GOLEM_PLATING_DUMMY("item.extended_tinker.boots_golem_plating_dummy",  "石头傀儡战靴镶板"),
        BOOTS_GOLEM_PLATING("item.extended_tinker.boots_golem_plating", "傀儡战靴镶板"),
        BOOTS_GOLEM_PLATING_SAND_CAST("item.extended_tinker.boots_golem_plating_sand_cast", "傀儡战靴镶板沙子筑模"),
        BOOTS_GOLEM_PLATING_RED_SAND_CAST("item.extended_tinker.boots_golem_plating_red_sand_cast", "傀儡战靴镶板红沙筑模"),
        BOOTS_GOLEM_PLATING_CAST("item.extended_tinker.boots_golem_plating_cast", "傀儡战靴镶板金质铸模"),
        GOLEM_BEACON("modifier.extended_tinker.golem_beacon", "傀儡信标"),
        GOLEM_BEACON_FLAVOR("modifier.extended_tinker.golem_beacon.flavor", "信标在脚下！"),
        GOLEM_BEACON_DESCRIPTION("modifier.extended_tinker.golem_beacon.description", "与信标靴效果相同。"),
        GOLEM_WEAPON("modifier.extended_tinker.golem_weapon", "傀儡武器"),
        GOLEM_WEAPON_FLAVOR("modifier.extended_tinker.golem_weapon.flavor", "勉强够用！"),
        GOLEM_WEAPON_DESCRIPTION("modifier.extended_tinker.golem_weapon.description", "大型金属傀儡现在可以使用这把武器。"),
