...
public class zh_cn implements ILang {
    enum LangData implements ILangData {
        ...
        STAT_DRAGON_ARMOR_CORE_HEAD("stat.extended_tinker.dragon_armor_core_head", "龙铠基底"),
        PART_DRAGON_ARMOR_CORE_BODY("item.extended_tinker.dragon_armor_core_body", "龙铠基底"),
        STAT_DRAGON_ARMOR_CORE_BODY("stat.extended_tinker.dragon_armor_core_body", "龙铠基底"),
        PART_DRAGON_ARMOR_CORE_NECK("item.extended_tinker.dragon_armor_core_neck", "龙铠基底"),
        STAT_DRAGON_ARMOR_CORE_NECK("stat.extended_tinker.dragon_armor_core_neck", "龙铠基底"),
        PART_DRAGON_ARMOR_CORE_TAIL("item.extended_tinker.dragon_armor_core_tail", "龙铠基底"),
        STAT_DRAGON_ARMOR_CORE_TAIL("stat.extended_tinker.dragon_armor_core_tail", "龙铠基底"),
