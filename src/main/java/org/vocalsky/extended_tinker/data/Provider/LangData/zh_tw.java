...
public class zh_tw implements ILang {
    enum LangData implements ILangData {
        ...
        SHOOT_FIREWORK("modifier.extended_tinker.shoot_firework", "煙火發射器"),
        SHOOT_FIREWORK_FLAVOR("modifier.extended_tinker.shoot_firework.flavor", "發射煙火！"),
        SHOOT_FIREWORK_DESCRIPTION("modifier.extended_tinker.shoot_firework.description", "給予弓1個煙火槽位；手持弓並按下“攻擊”鍵以切換槽位，潛行時並按下“攻擊”鍵以訪問這些槽位"),
        SHOOT_FIREWORK_SELECTED("modifier.extended_tinker.shoot_firework.selected", "煙火發射器：選用%2$s號槽位中%1$s"),
        SHOOT_FIREWORK_DISABLED("modifier.extended_tinker.shoot_firework.disabled", "煙火發射器：禁用"),
        FIREWORK_STAR("modifier.extended_tinker.firework_star", "煙火之星"),
        FIREWORK_STAR_FLAVOR("modifier.extended_tinker.firework_star.flavor", "搭載煙火之星"),
        FIREWORK_STAR_DESCRIPTION("modifier.extended_tinker.firework_star.description", "擁有了煙火之星的能力。"),
        STAR_FIRECRACK_DESCRIPTION("modifier.extended_tinker.star_firecrack.description", "擁有了煙火之星的能力。"),
        SAFETY_FIREWORK("modifier.extended_tinker.safety_firework", "安全煙火"),
        SAFETY_FIREWORK_FLAVOR("modifier.extended_tinker.safety_firework.flavor", "安全第一！"),
        SAFETY_FIREWORK_DESCRIPTION("modifier.extended_tinker.safety_firework.description", "煙火將不再傷害到使用者。"),
        ...
        GOLEM_BOOTS("item.extended_tinker.golem_boots", "傀儡裝甲戰靴"),
        GOLEM_BOOTS_DESCRIPTION("item.extended_tinker.golem_boots.description", "為大型金屬傀儡訂製。"),
        ...
        HELMET_GOLEM_PLATING_CAST("item.extended_tinker.helmet_golem_plating_cast", "傀儡頭盔鑲板金質鑄模"),
        ...
        CHESTPLATE_GOLEM_PLATING_CAST("item.extended_tinker.chestplate_golem_plating_cast", "傀儡胸甲鑲板金質鑄模"),
        ...
        LEGGINGS_GOLEM_PLATING_CAST("item.extended_tinker.leggings_golem_plating_cast", "傀儡護腿鑲板金質鑄模"),
        PATTERN_BOOTS_GOLEM_PLATING("pattern.extended_tinker.boots_golem_plating", "傀儡戰靴鑲板"),
        BOOTS_GOLEM_PLATING_DUMMY("item.extended_tinker.boots_golem_plating_dummy",  "石頭傀儡戰靴鑲板"),
        BOOTS_GOLEM_PLATING("item.extended_tinker.boots_golem_plating", "傀儡戰靴鑲板"),
        BOOTS_GOLEM_PLATING_SAND_CAST("item.extended_tinker.boots_golem_plating_sand_cast", "傀儡戰靴鑲板沙子築模"),
        BOOTS_GOLEM_PLATING_RED_SAND_CAST("item.extended_tinker.boots_golem_plating_red_sand_cast", "傀儡戰靴鑲板紅沙築模"),
        BOOTS_GOLEM_PLATING_CAST("item.extended_tinker.boots_golem_plating_cast", "傀儡戰靴鑲板金質鑄模"),
        GOLEM_BEACON("modifier.extended_tinker.golem_beacon", "傀儡信標"),
        GOLEM_BEACON_FLAVOR("modifier.extended_tinker.golem_beacon.flavor", "信標在腳下！"),
        GOLEM_BEACON_DESCRIPTION("modifier.extended_tinker.golem_beacon.description", "與信標靴效果相同。"),
        GOLEM_WEAPON("modifier.extended_tinker.golem_weapon", "傀儡武器"),
        GOLEM_WEAPON_FLAVOR("modifier.extended_tinker.golem_weapon.flavor", "勉強夠用！"),
        GOLEM_WEAPON_DESCRIPTION("modifier.extended_tinker.golem_weapon.description", "大型金屬傀儡現在可以使用這把武器。"),
