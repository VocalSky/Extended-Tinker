...
public class zh_tw implements ILang {
    enum LangData implements ILangData {
        ...
        LEGGINGS_GOLEM_PLATING_CAST("item.extended_tinker.leggings_golem_plating_cast", "傀儡護腿鑲板金製鑄模"),DRAGON_ARMOR_IRON("item.extended_tinker.dragonarmor_iron", "龍鎧"),
        DRAGON_ARMOR_COPPER("item.extended_tinker.dragonarmor_copper", "龍鎧"),
        DRAGON_ARMOR_SILVER("item.extended_tinker.dragonarmor_silver", "龍鎧"),
        DRAGON_ARMOR_GOLD("item.extended_tinker.dragonarmor_gold", "龍鎧"),
        DRAGON_ARMOR_DIAMOND("item.extended_tinker.dragonarmor_diamond", "龍鎧"),
        DRAGON_ARMOR_FIRE("item.extended_tinker.dragonarmor_dragonsteel_fire", "龍鎧"),
        DRAGON_ARMOR_ICE("item.extended_tinker.dragonarmor_dragonsteel_ice", "龍鎧"),
        DRAGON_ARMOR_LIGHTNING("item.extended_tinker.dragonarmor_dragonsteel_lightning", "龍鎧"),
        ...
        STAT_DRAGON_ARMOR_IRON("stat.extended_tinker.dragonarmor_iron", "龍鎧基底"),
        STAT_DRAGON_ARMOR_COPPER("stat.extended_tinker.dragonarmor_copper", "龍鎧基底"),
        STAT_DRAGON_ARMOR_SILVER("stat.extended_tinker.dragonarmor_silver", "龍鎧基底"),
        STAT_DRAGON_ARMOR_GOLD("stat.extended_tinker.dragonarmor_gold", "龍鎧基底"),
        STAT_DRAGON_ARMOR_DIAMOND("stat.extended_tinker.dragonarmor_diamond", "龍鎧基底"),
        STAT_DRAGON_ARMOR_FIRE("stat.extended_tinker.dragonarmor_fire", "龍鎧基底"),
        STAT_DRAGON_ARMOR_ICE("stat.extended_tinker.dragonarmor_ice", "龍鎧基底"),
        STAT_DRAGON_ARMOR_LIGHTNING("stat.extended_tinker.dragonarmor_lightning", "龍鎧基底"),
        ...
        PART_DRAGON_ARMOR_COPPER_CORE_HEAD("item.extended_tinker.dragon_armor_copper_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_BODY("item.extended_tinker.dragon_armor_copper_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_NECK("item.extended_tinker.dragon_armor_copper_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_COPPER_CORE_TAIL("item.extended_tinker.dragon_armor_copper_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_HEAD("item.extended_tinker.dragon_armor_silver_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_BODY("item.extended_tinker.dragon_armor_silver_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_NECK("item.extended_tinker.dragon_armor_silver_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_SILVER_CORE_TAIL("item.extended_tinker.dragon_armor_silver_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_IRON_CORE_HEAD("item.extended_tinker.dragon_armor_iron_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_IRON_CORE_BODY("item.extended_tinker.dragon_armor_iron_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_IRON_CORE_NECK("item.extended_tinker.dragon_armor_iron_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_IRON_CORE_TAIL("item.extended_tinker.dragon_armor_iron_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_HEAD("item.extended_tinker.dragon_armor_gold_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_BODY("item.extended_tinker.dragon_armor_gold_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_NECK("item.extended_tinker.dragon_armor_gold_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_GOLD_CORE_TAIL("item.extended_tinker.dragon_armor_gold_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_HEAD("item.extended_tinker.dragon_armor_diamond_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_BODY("item.extended_tinker.dragon_armor_diamond_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_NECK("item.extended_tinker.dragon_armor_diamond_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_DIAMOND_CORE_TAIL("item.extended_tinker.dragon_armor_diamond_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_HEAD("item.extended_tinker.dragon_armor_dragonsteel_fire_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_BODY("item.extended_tinker.dragon_armor_dragonsteel_fire_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_NECK("item.extended_tinker.dragon_armor_dragonsteel_fire_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_FIRE_CORE_TAIL("item.extended_tinker.dragon_armor_dragonsteel_fire_core_tail", "尾部基底"),
        PART_DRAGON_ARMOR_ICE_CORE_HEAD("item.extended_tinker.dragon_armor_dragonsteel_ice_core_head", "頭部基底"),
        PART_DRAGON_ARMOR_ICE_CORE_BODY("item.extended_tinker.dragon_armor_dragonsteel_ice_core_body", "軀體基底"),
        PART_DRAGON_ARMOR_ICE_CORE_NECK("item.extended_tinker.dragon_armor_dragonsteel_ice_core_neck", "脖頸基底"),
        PART_DRAGON_ARMOR_ICE_CORE_TAIL("item.extended_tinker.dragon_armor_dragonsteel_ice_core_tail", "尾部基底"),
